...
class Test extends StatefulWidget {
  ...
  const Test({Key? key, this.videoId}) : super(key: key);
  ...
  Future<void> onLoad() async {
    ...
    if (listvideo != null && listvideo!.docs.isNotEmpty) {
      ...
      if (widget.videoId != null) {
        var videoData = listvideo!.docs.firstWhere((doc) => (doc.data() as Map<String, dynamic>)['idvideo'] == widget.videoId).data() as Map<String, dynamic>;
        currentPlayingUrl = videoData['urlvideo'];
      } else {
                          ...
                          children: [
                            GestureDetector(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "Thích",
                                    style: TextStyle(color: clicked[index] ? Colors.blue : Colors.grey.shade600, fontSize: 18),
                                  ),
                                ],
                              ),
                            ),
                            GestureDetector(
                              onTap: () {
                                ...
                                //     context: context,
                                //     builder: (context) => Comment2(
                                //       idPoster: user['idUserposter'],
                                //       idNewsfeed: user['idvideo'],
                                //     ));
                              },
                              child: Container(
                                child: Row(
